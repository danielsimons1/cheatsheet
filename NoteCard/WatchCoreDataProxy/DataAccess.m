...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Note Cards"];
...
- (NSFetchedResultsController *)fetchedScreenshotsResultsController:(CSData *)csdata
{
    ...
    // Edit the section name key path and cache name if appropriate.
    // nil for section name key path means "no sections".
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"My Note Card Screens"];
    aFetchedResultsController.delegate = self;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.unofficialcalculators.NoteCard" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"NoteCard" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSString *kMyAppGroupName = @"group.com.unofficialcalculators.NoteCard";
    NSURL *sharedContainerURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:kMyAppGroupName];
    
    NSURL *storeURL = [sharedContainerURL URLByAppendingPathComponent:@"NoteCard.sqlite"];
    NSError *error = nil;
...
- (void)saveContext {
    ...
    if (managedObjectContext != nil) {
        ...
        if ([managedObjectContext hasChanges] && ![managedObjectContext save:&error]) {
            ...
            [NSFetchedResultsController deleteCacheWithName:@"Note Cards"];
        }
    }
}
